...
const DropZone = () => {
  ...
  const { accessToken, isOnFreePlan, openLoginPopup } = useAuth();
                    ...
                    >
                      {showOptions && toolConfig.hasOptions && (
                        <>
                          ...
                          {
                            // الشروط الخارجية: أي أداة متحققة ي render ال div الخارجي
                            ((currentTool === TOOL_TYPES.ENHANCE &&
                              accessToken &&
                              !isOnFreePlan) ||
