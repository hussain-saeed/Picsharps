  ...
  return (
    <>
      ...
      >
        <Container>
          <TitleBlock
            subtitle={t["SEAMLESS BACKGROUNDS"]}
            title={t["BACKGROUND TOOLS"]}
            description={
              t[
                "Quickly remove, replace, or clean image backgrounds with reliable AI for flawless cutouts and realistic scene rebuilding. Perfect for product shots, portraits, and social posts — fast, precise, and natural-looking results"
              ]
            }
          />
      ...
      >
        <Container>
          <TitleBlock
            subtitle={t["PROFESSIONAL ENHANCEMENTS"]}
            title={t["ENHANCE & CLEANUP"]}
            description={
              t[
                "Speed up your workflow with smart enhancement and cleanup tools that make images look polished and professional. From one-click fixes to fine-grained control, these tools remove noise, boost details, and restore clarity while keeping results natural"
              ]
            }
          />
          ...
          <div className="mt-20">
            <PresentService
              ...
              description={
                t[
                  "Boost perceived clarity by enhancing edge definition and micro-contrast while avoiding unwanted halos. The algorithm selectively targets soft areas like eyes, hair, and textures to create crisp, camera-ready results. Adjustable sliders let users control Amount, Radius, and Threshold for precise tuning. Works well in combination with the Enhancer for final refinement and is safe to apply in small increments to avoid noise amplification. Perfect for rescuing slightly soft or slightly out-of-focus photos."
                ]
              }
      ...
      >
        <Container>
          <TitleBlock
            subtitle={t["CREATIVE TRANSFORMS"]}
            title={t["Artistic Effects & Filters"]}
            description={
              t[
                "Unlock playful and artistic options to reimagine photos with stylized filters, cartoon conversions, and creative layouts. These tools make it easy to generate shareable content, unique assets, and eye-catching visuals for social media or campaigns"
              ]
            }
          />
      ...
      >
        <Container>
          <TitleBlock
            subtitle={t["ESSENTIAL EDITS"]}
            title={t["BASIC EDITS"]}
            description={
              t[
                "Core, quick-edit tools for resizing, framing, and flipping images — simple operations that are essential in every editing workflow. Fast, reliable, and designed to pair seamlessly with the AI-powered features for a complete editing experience"
              ]
            }
          />
          ...
          <div className="mt-20">
            <PresentService
              ...
              description={
                t[
                  "Recompose photos with precision using freeform crop, preset ratios, and rule-of-thirds guides to improve framing instantly. Auto-suggestions highlight better crops based on subject positioning and visual balance. Edge-aware cropping keeps important areas visible and allows non-destructive crops saved as versions. Quick keyboard shortcuts and snap-to guides speed up iterative adjustments during editing sessions. Ideal for tightening composition for thumbnails, profile pictures, and layout-ready assets."
                ]
              }
              linkTo="/crop-image"
              innerLinkText={t["Try it Now"]}
          ...
          <div className="mt-20">
            <PresentService
              ...
              description={
                t[
                  "Combine multiple photos into cohesive, well-composed collages using modern templates and flexible grid controls. Drag-and-drop placement, rounded corners, and consistent spacing keep the layout neat while smart cropping preserves important subject areas. Templates include thematic choices (travel, portfolio, product grid) and adjustable aspect ratios for Instagram posts or story formats. Users can add optional frames, subtle shadows, and color-coordinated backgrounds for polish. Excellent for moodboards, social campaigns, and multi-photo storytelling."
                ]
              }
